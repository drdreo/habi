...
@Component({
    selector: "dark-theme-switch",
    standalone: true,
    imports: [CommonModule, MatSlideToggleModule],
    templateUrl: "./dark-theme-switch.component.html",
    styleUrl: "./dark-theme-switch.component.scss",
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DarkThemeSwitchComponent implements AfterViewInit {
